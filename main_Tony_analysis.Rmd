...
```{r}
#remove outlier productions (probably should not do this. The fact that these productions stayed open unusally long makes them important)
...
```{r}
ggplot(long_lm_df, aes(x = wins_coeff, y = year)) +
...
ggplot(long_lm_df, aes(x = noms_coeff, y = year)) +
  geom_vline(xintercept = 0,lwd=1,colour="black", linetype = 2) +
...
```{r}
ggplot(long_lm_df, aes(x = noms_coeff)) +
...
ggplot(long_lm_df, aes(x = wins_coeff)) +
  geom_histogram(color = "black", fill = "skyblue") +
  geom_vline(xintercept = 0,lwd=.5,colour="maroon", linetype = 2) +
  ggtitle("Distribution of Yearly Regression Model Slopes for Nominations") +
  labs(x = "wins effect size") +
...
ggplot(ts_df, aes(x = wins_coeff, y = year)) +
  geom_vline(xintercept = 0,lwd=1,colour="black", linetype = 2) +
  geom_errorbar(aes(xmin = CI_1_wins, xmax = CI_2_wins), alpha = 2,color = "skyblue") + 
  geom_point(color = "maroon") +
  labs(x = "wins effect size") +
...
ggplot(ts_df, aes(x = noms_coeff, y = year)) +
  geom_vline(xintercept = 0,lwd=1,colour="black", linetype = 2) +
  geom_errorbar(aes(xmin = CI_1_noms, xmax = CI_2_noms), alpha = 2,color = "skyblue") + 
  geom_point(color = "maroon") +
  labs(x = "nominations effect size") +
...
ggplot(ts_df, aes(x = weeks_open_coeff, y = year)) +
  geom_vline(xintercept = 0,lwd=1,colour="black", linetype = 2) +
...
ggplot(ts_df, aes(x = noms_weeks_coeff, y = year)) +
  geom_vline(xintercept = 0,lwd=1,colour="black", linetype = 2) +
...
ggplot(ts_df, aes(x = wins_weeks_coeff, y = year)) +
  geom_vline(xintercept = 0,lwd=1,colour="black", linetype = 2) +
